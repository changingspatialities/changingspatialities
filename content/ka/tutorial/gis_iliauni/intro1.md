...
წერტილოვან ან ხაზოვან ინფორმაციაზე დაყრდნობით, რომელსაც მაგალითად აქვს სიმაღლის ატრიბუტული მონაცემი (`Z` ღერძი. მაგალითად ე.წ. ტოპო), შეიძლება შეიქმნას ე.წ. mesh, ან როგორც სხვანაირად ეწოდება TIN (ინგლ. Triangulated Irregular Network) <b>იხილეთ სურათი 1.4.ბ.</b>
...
რაც შეეხება რასტრულ მონაცემებს, ჩვენი პროექტის მიზნებიდან გამომდინარე, გამოვიყენებთ საბჭოთა ტოპოგრაფიულ რუკას, რომელიც შენახული .tiff ფორმატში. 

## 1.8. შეჯამება

ამ ნაწილში გავეცანით გეოგრაფიული ინფორმაციული სისტემების გამოყენებისთვის აუცილებელ საბაზისო ცნებებსა და ტერმინებს, რომელიც მნიშვნელოვანია ვიცოდეთ QGIS-ში მუშაობისას. შემდეგ ნაწილში დეტალურად გავივლით ვექტორული პოლიგონური მონაცემების შექმნასა და შენახვას ატრიბუტული ინფორმაციის თანხლებით. 