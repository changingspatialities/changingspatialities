...
<div class="row">
  <div class="column" style="">
    <p>{{< figure src="/img/landscape_geometry.jpeg" width=100% title="სურ. 1.ა. როგორ გადაითარგმნებოდა მოცემული ბუნებრივი ლანდშაფტი GIS გარემოში - მდინარე (ლურჯი) და გზები (მწვანე) ხაზების, ხეები (წითელი) წერტილების, ხოლო ნაგებობები (თეთრი) პოლიგონების სახით.<br>წყარო: qgis დოკუმენტაცია">}}</p>
  </div>
</div>
